...
function news_store_ux_builder_element() {
    ...
    $repeater_post_type = 'store';

    $repeater_col_spacing = 'normal';



    $repeater_post_cat = 'store_cat';
    ...
    add_ux_builder_shortcode('ux_news_store', array(
...
add_action('ux_builder_setup', 'news_store_ux_builder_element');



function news_store_shortcode($atts)
...
<div class="col" <?php echo $animate;?>>
    ...
    <div class="col-inner">
        ...
        <div class="plain">
            ...
            <div class="box-store">
                <div class="box-map">
                    <?php echo get_field('map_store', get_the_ID()); ?>
                </div>
                <div class="box-text-store">
                    <h4>Địa chỉ chính</h4>
                    <p><?php echo get_field('address_store', get_the_ID()); ?></p>
                </div>
            </div>
...
add_shortcode('ux_news_store', 'news_store_shortcode');