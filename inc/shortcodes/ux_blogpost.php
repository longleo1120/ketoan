...
function news_post_ux_builder_element() {
    ...
    add_ux_builder_shortcode('ux_news_post', array(
...
add_action('ux_builder_setup', 'news_post_ux_builder_element');



function news_post_shortcode($atts)
...
add_shortcode('ux_news_post', 'news_post_shortcode');