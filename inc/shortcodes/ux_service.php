...
function news_service_ux_builder_element() {
    ...
    $repeater_post_type = 'service';

    $repeater_col_spacing = 'normal';



    $repeater_post_cat = 'service_cat';
    ...
    add_ux_builder_shortcode('ux_news_service', array(
...
add_action('ux_builder_setup', 'news_service_ux_builder_element');



function news_service_shortcode($atts)
...
<div class="col service-item <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
    ...
    <div class="col-inner">
        ...
        <div class="plain">
            ...
            <div class="box-service">
                ...
                <?php do_action('flatsome_blog_service_before'); ?>
                ...
                <div class="box-service-text">
                    ...
                    <a href=<?php the_permalink() ?>" class="button mt-half primary is-outline is-large lowercase btn-main view-service" style="border-radius:99px;"><span>Xem thêm</span></a>
                </div>
...
add_shortcode('ux_news_service', 'news_service_shortcode');