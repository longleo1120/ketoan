...
function news_client_ux_builder_element() {
    ...
    $repeater_post_type = 'client';

    $repeater_col_spacing = 'normal';



    $repeater_post_cat = 'client_cat';
    ...
    add_ux_builder_shortcode('ux_news_client', array(
...
add_action('ux_builder_setup', 'news_client_ux_builder_element');



function news_client_shortcode($atts)
...
<div class="col client-item <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
    ...
    <div class="col-inner">
        ...
        <div class="plain">
            ...
            <div class="box-client">
                ...
                <?php do_action('flatsome_blog_client_before'); ?>
...
add_shortcode('ux_news_client', 'news_client_shortcode');